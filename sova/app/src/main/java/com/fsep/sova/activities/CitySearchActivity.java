...
import com.fsep.sova.fragments.CitySearchFragment;
...
public class CitySearchActivity extends BaseActivity {
    ...
    private BaseSearchFragment mCityFragment = new CitySearchFragment();
    ...
    private void initFragment() {
        mCityFragment.setArguments(getIntent().getExtras());
        FragmentManager manager = getSupportFragmentManager();
        if (manager.findFragmentById(R.id.search_fragment) == null) {
            manager.beginTransaction()
                    .add(R.id.search_fragment, mCityFragment, Constants.FRAGMENT_TAG)
                    .commit();
        } else {
            manager.beginTransaction()
                    .replace(R.id.search_fragment, mCityFragment, Constants.FRAGMENT_TAG)
                    .commit();
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(mCityFragment.getQueryTextListener());
